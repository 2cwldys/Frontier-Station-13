...
/datum/map_template/ruin/away_site/crashed_elyran_tanker
	...
	suffix = "crashed_elyran_tanker.dmm"

	sectors = list(SECTOR_ROMANOVICH, SECTOR_DEEP_FRONTIER, SECTOR_CORP_ZONE, SECTOR_VALLEY_HALE, SECTOR_TABITI, SECTOR_BADLANDS, SECTOR_AEMAQ)
	spawn_weight = 1
	spawn_cost = 1
