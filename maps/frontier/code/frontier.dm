/datum/map/frontier
	...
	overmap_visitable_type = /obj/effect/overmap/visitable/ship/frontier
	...
	warehouse_basearea = /area/frontier/operations/warehouse
	warehouse_packagearea = /area/frontier/operations/package_conveyors
...
/datum/map/frontier/send_welcome()
	...
	var/welcome_text = "<center><img src = scclogo.png><br />[FONT_LARGE("<b>Frontier</b> Ultra-Range Sensor Readings:")]<br>"
	...
	if (horizon) //If the overmap is disabled, it's possible for there to be no Frontier.
	...
	post_comm_message("Frontier Sensor Report", welcome_text)
...
/datum/map/frontier/load_holodeck_programs()
...
/obj/effect/map_effect/marker/mapmanip/submap/extract/frontier/ops_warehouse_small_storage
	name = "Ops Warehouse, Small Storage"

/obj/effect/map_effect/marker/mapmanip/submap/insert/frontier/ops_warehouse_small_storage
	name = "Ops Warehouse, Small Storage"
