...
/datum/shuttle/autodock/multi/antag/skipjack_ship
	...
	announcer = "SCCV Frontier Sensor Array"
	arrival_message = "Attention, the radar systems have detected a small spacecraft approaching the ship's perimeter."
	departure_message = "Attention, the radar systems have detected a small spacecraft leaving the ship's perimeter. "
...
/datum/shuttle/autodock/overmap/intrepid
	name = "Intrepid"
	move_time = 20
	shuttle_area = list(/area/frontier/shuttle/intrepid/main_compartment, /area/frontier/shuttle/intrepid/port_compartment, /area/frontier/shuttle/intrepid/starboard_compartment, /area/frontier/shuttle/intrepid/junction_compartment, /area/frontier/shuttle/intrepid/buffet, /area/frontier/shuttle/intrepid/medical, /area/frontier/shuttle/intrepid/engineering, /area/frontier/shuttle/intrepid/port_storage, /area/frontier/shuttle/intrepid/flight_deck)
...
/obj/effect/shuttle_landmark/intrepid/hangar
	...
	base_area = /area/frontier/hangar/intrepid
...
/datum/shuttle/autodock/overmap/canary
	name = "Canary"
	move_time = 20
	shuttle_area = list(/area/frontier/shuttle/canary)
...
/obj/effect/shuttle_landmark/canary/hangar
	...
	base_area = /area/frontier/hangar/auxiliary
	base_turf = /turf/simulated/floor/plating
...
/datum/shuttle/autodock/overmap/quark
	name = "Quark"
	move_time = 20
	shuttle_area = list(/area/frontier/shuttle/quark/cockpit, /area/frontier/shuttle/quark/cargo_hold)
...
/datum/shuttle/autodock/overmap/mining
	name = "Spark"
	move_time = 20
	shuttle_area = /area/frontier/shuttle/mining
...
/obj/effect/shuttle_landmark/mining/hangar
	...
	base_area = /area/frontier/hangar/operations
