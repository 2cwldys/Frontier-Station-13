...
/mob/living/carbon/human/handle_regular_status_updates()
	...
	if(species.show_ssd && (!client && !vr_mob) && !teleop && !deliberately_clientless && ((world.realtime - disconnect_time) >= 5 MINUTES)) //only sleep after 5 minutes, should help those with intermittent internet connections
		Sleeping(2)
