...
/obj/item/clothing/under/lance
	name = "hub lancer fatigues"
	desc = "A set of drab fatigues meant to be worn by the Hub Lancer Regiment, with their emblem found on the shoulder."
...
/obj/item/clothing/under/dress/lance_dress
	...
	desc = "A dark black uniform indicative of a Hub Lancer official with a badge atop the chest. This one seems tailored  to take on a more feminine look, with a long skirt."
...
/obj/item/clothing/under/dress/lance_dress/male
	name = "lance dress uniform"
	desc = "A dark black uniform indicative of a Hub Lancer official with a badge atop the chest."
...
/obj/item/clothing/under/rank/lance
	name = "\improper Hub Lancer tactical uniform"
	desc = "A newly-issued dark grey uniform worn by Hub Lancer operatives during combat situations."
