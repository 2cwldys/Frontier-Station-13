...
/datum/category_item/player_setup_item/general/flavor/load_character(var/savefile/S)
	S["neural_lace"] >> pref.neural_lace
	if(isnull(pref.neural_lace)) pref.neural_lace = TRUE  // default on for new characters
...
/datum/category_item/player_setup_item/general/flavor/content(var/mob/user)
	var/list/dat = list(
		"<b>Neural Lace:</b><br>",
		"<a href='byond://?src=[REF(src)];toggle_neural_lace=1'>Neural Lace: [pref.neural_lace ? "<b>Installed</b>" : "None"]</a><br/>",
		"<i>If enabled, your character will have a neural lace installed on spawn. Preserves consciousness on death.</i><br/><br/>",
		"<b>Flavor:</b><br>",
...
/datum/category_item/player_setup_item/general/flavor/OnTopic(var/href,var/list/href_list, var/mob/user)
	if(href_list["toggle_neural_lace"])
		pref.neural_lace = !pref.neural_lace
