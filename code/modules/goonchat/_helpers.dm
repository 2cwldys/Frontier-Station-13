// Macros from Serenity that aren't in Aurora
...
// icon2base64, icon2html, icon2base64html, costly_icon2html already defined in code/__HELPERS/icons.dm

// Duplicate icon procs removed — use Aurora's versions from code/__HELPERS/icons.dm