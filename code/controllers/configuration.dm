...
//	var/enable_authentication = 0		// goon authentication
	...
	var/character_slots = 1				// Base character slots for normal players (persistent world: 1)
	var/admin_character_slots = 3			// Character slots for admins
	...
	//Unversal modifiers
	var/walk_speed = 2       // Persistent world default: ~4 deciseconds/step walk, ~2.5 run
	...
	for(var/t in Lines)
		...
		if(type == "config")
			...
			switch(name)
				...
				if("walk_speed")
					GLOB.config.walk_speed = text2num(value)
